.PHONY: setup run stop clean download load logs build update setup-dev lint test format precompute-phonetic precompute-edges test-frontend test-e2e test-integration test-all collect-fixtures bench-layout-baseline
